...
echo "lib seams : $(ls src/lib/{adopt,undoOps,tangleOps,intentionOps,tidyPanel,settle,pushGovernor,summaryAccept,tangleGate,receiptWindow}.ts 2>/dev/null | wc -l | tr -d ' ')/10 present"
echo
